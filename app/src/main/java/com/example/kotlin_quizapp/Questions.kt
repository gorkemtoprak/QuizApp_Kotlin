...
class Questions : AppCompatActivity() {
    ...
    private var questionList: ArrayList<QuestionList>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        submit.setOnClickListener {
            if(selecedOption!=0)
            {
                ...
                setColor(question.answer,R.drawable.correct_question_option)
    ...
    fun setQuestion(){
        ...
        opt_1.text=question.optOne
        opt_2.text=question.optTwo
        opt_3.text=question.optThree
        opt_4.text=question.optFour
